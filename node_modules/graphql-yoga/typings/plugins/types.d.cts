...
export declare type Plugin<PluginContext extends Record<string, any> = {}, TServerContext extends Record<string, any> = {}, TUserContext = {}> = EnvelopPlugin<YogaInitialContext & PluginContext> & {
    /**
...
export declare type OnYogaInitHook<TServerContext extends Record<string, any>> = (payload: OnYogaInitEventPayload<TServerContext>) => void;
export declare type OnYogaInitEventPayload<TServerContext extends Record<string, any>> = {
...
export declare type ResultProcessorInput = MaybeArray<ExecutionResult> | AsyncIterable<ExecutionResult>;
