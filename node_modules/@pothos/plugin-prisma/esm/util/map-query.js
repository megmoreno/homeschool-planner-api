...
export function queryFromInfo({ context, info, typeName, select, path = [] }) {
    ...
    if (path.length > 0) {
        var _extensions;
        const { pothosPrismaIndirectInclude } = (_extensions = returnType.extensions) !== null && _extensions !== void 0 ? _extensions : {};
        var ref;
        resolveIndirectInclude(returnType, info, info.fieldNodes[0], (ref = pothosPrismaIndirectInclude === null || pothosPrismaIndirectInclude === void 0 ? void 0 : pothosPrismaIndirectInclude.path) !== null && ref !== void 0 ? ref : [], [], (indirectType, indirectField, subPath) => {
